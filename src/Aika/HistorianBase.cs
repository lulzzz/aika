...
namespace Aika {
    ...
    public abstract class HistorianBase : IHistorian {
        ...
        /// </returns>
        public abstract Task<StateSet> CreateStateSet(ClaimsPrincipal identity, string name, IEnumerable<StateSetItem> states, CancellationToken cancellationToken);
        ...
        /// </returns>
        public abstract Task<StateSet> UpdateStateSet(ClaimsPrincipal identity, string name, IEnumerable<StateSetItem> states, CancellationToken cancellationToken);
